...
if __name__ == "__main__":
    ...
    arguments = {
        "input": r"TREC_eda1.txt",
        "input_labels": r"TREC_labels_eda1.txt",
        "output_clean": r"TREC.clean_backtranslation_eda1.txt",
        "output": r"TREC_backtranslation_eda1.txt",
        "output_labels": r"TREC_labels_backtranslation_eda1.txt",
        "target_lang": "iw"
    }
